 ...
 * @param {Exhibit.UIContext} uiContext
 */
Exhibit.Formatter._MarkdownFormatter = function(uiContext) {
};
 ...
 * @param {Function} appender
 */
Exhibit.Formatter._MarkdownFormatter.prototype.format = function(value, appender) {
    var md = marked.parse(value);
    var span = Exhibit.jQuery("<span class='markdown'>").html(md);
    appender(span);
};

// END MARKDOWN_SUPPORT
...
Exhibit.Formatter._constructors = {
    ...
    "markdown" : Exhibit.Formatter._MarkdownFormatter
};
